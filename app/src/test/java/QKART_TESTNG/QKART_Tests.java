...
public class QKART_Tests {
    ...
    public void TestCase03() throws InterruptedException {
        ...
        assertTrue(status, "search for YONEX product Failed");
        ...
        for (WebElement webElement : searchResults) {
            ...
            assertEquals(resultelement.getTitleofResult(), "YONEX Smash Badminton Racquet", "Test Case Failure. Test Results contains un-expected values:");
        }
        ...
        assertTrue(searchResults.isEmpty(), "Test Case Failure. Results were available");
        assertTrue(homePage.isNoResultFound(),"Test Case Fail. Expected: no result");
        ...
        for (WebElement webElement : searchResults) {
            ...
            //     logStatus("Step Success", "Successfully validated presence of Size Chart Link", "PASS");
                ...
                //if (result.openSizechart()) {
                    ...
                    assertTrue(status, "SIze chart is not opening");
    ...
    public void  testCase05(@Optional("YONEX")  String TC5_ProductNameToSearchFor, @Optional("Tan Leatherette Weekender Duffle") String TC5_ProductNameToSearchFor2,@Optional("Addr line 1 addr Line 2 addr line 3") String TC5_AddressDetails) throws InterruptedException {
        Boolean status;
    ...
    public void TestCase06(String TC6_ProductNameToSearch1, String TC6_ProductNameToSearch2) throws InterruptedException {
        ...
        assertTrue(status,"Test Case 6: Verify that cart cannot be edited");
}
    ...
    public void testCase07(String TC7_ProductName, int TC7_Qty) throws InterruptedException {
        ...
        assertTrue(status, "Verify that insufficient balance error is thrown when the wallet balance is not enough Failed");
    }
    ...
    public void TestCase08() throws InterruptedException {
        ...
        // }
        assertTrue(status, "User Perform Registeration Failed");
        lastGeneratedUserName = registration.lastGeneratedUsername;
        ...
        assertTrue(status, "Verify that product added to cart is available when a new tab is opened failed");
    }
    ...
    public void TestCase09() throws InterruptedException {
        ...
        assertTrue(PrivacyPolicyHeading.getText().equals("Privacy Policy"), "Verifying new tab opened has Privacy Policy page heading failed");
        ...
        assertTrue(TOSHeading.getText().equals("Terms of Service"), "Verifying new tab opened has Terms Of Service page heading failed");
        // if (!status) {
        ...
        // return status;
        assertTrue(status, "Verify that the Privacy Policy, About Us are displayed correctly Failed");
    }
    ...
    public void TestCase10() throws InterruptedException {
        ...
        // return true;
        //assertTrue(ExpectedConditions.invisibilityOf(contactUs));
    ...
    public void TestCase11() throws InterruptedException {
        ...
        // }
        assertTrue(status, "Registeration Failed");
        lastGeneratedUserName = registration.lastGeneratedUsername;
